 ...
 */
package com.liulishuo.engzo.lingorecorder.demo.progressbutton;
...
public class CircleProgressButton extends View {
     ...
     * 圆弧渐变的角度增加
     */
    private int everyIntervalAngle = 3;
            ...
            switch (msg.what) {
                case PROGRESS_PLUS:
                    ...
                    if (isEnd) {
                        ...
                        Log.i("ActivityCircleProgress", "stop: "+System.currentTimeMillis());
                        removeMessages(PROGRESS_PLUS);
                    } else {
                        if(sweepAngle==0){
                            mCircleProcessListener.onStart();
                        }

                        sweepAngle += everyIntervalAngle;
                        invalidate();
                        sendEmptyMessageDelayed(PROGRESS_PLUS, 10000/120);
                    }
                    break;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                Log.i("ActivityCircleProgress", "begin: "+System.currentTimeMillis());
                // 按下的动画
                if (isEnd) {
                    sweepAngle = 0;
                }
