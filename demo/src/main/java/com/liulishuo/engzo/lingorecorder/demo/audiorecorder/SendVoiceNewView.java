...
//        canvas.drawRect(getWidth() / 2 - ovalWidth / 2,getHeight()/2 - ovalWidth/2,getWidth() / 2 + ovalWidth / 2,getHeight()/2 + ovalWidth/2,greenPaint);
    ...
    public void setIsAnim(boolean doAnim){
        this.doAnim=doAnim;
        if(doAnim){
            alphaPrecent="00";
        }else{
...
//        }
    ...
    public void onStart(){
        ...
        centerAnimatorSet = new AnimatorSet();
...
//        rightAnimatorSet.end();
//        leftAnimatorSet.end();
//        centerAnimatorSet.end();
        rightAnimatorSet.cancel();
        leftAnimatorSet.cancel();
        centerAnimatorSet.cancel();
    }
